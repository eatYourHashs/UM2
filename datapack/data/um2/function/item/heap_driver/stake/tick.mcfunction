...
execute if entity @s[tag=um2.block_hit] run scoreboard players add @s um2.dummy2 1
execute if entity @s[tag=um2.block_hit] if score @s um2.dummy2 matches 45.. run function um2:item/heap_driver/stake/strike
...
execute if entity @s[tag=um2.returning] at @s facing entity @p[tag=um2.user] eyes facing ^ ^ ^-1.5 run tp @s ^ ^ ^-1.5 ~ ~
execute if entity @s[tag=um2.returning] at @s if entity @p[tag=um2.user,distance=..3] run function um2:item/heap_driver/stake/kill
