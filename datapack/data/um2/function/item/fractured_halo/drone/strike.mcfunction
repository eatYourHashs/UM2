...
summon minecraft:item_display ~ ~-3 ~ {brightness:{block:15,sky:15},interpolation_duration:4,teleport_duration:4,Tags:["um2.ticking","um2.new","um2.entity","smithed.entity","um2.fractured_halo_strike"],item_display:"head",item:{id:"minecraft:structure_block",count:1,components:{"minecraft:item_model":"um2:anim/fractured_halo_strike"}}}
