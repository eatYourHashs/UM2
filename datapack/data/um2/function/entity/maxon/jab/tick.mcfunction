execute if score @s um2.dummy matches 1..14 run function um2:entity/maxon/jab/tracking
execute if score @s[tag=um2.jab_followup] um2.dummy matches 20..30 run function um2:entity/maxon/jab/tracking
...
execute if score @s um2.dummy matches 20 if score @s um2.diff matches 2 run scoreboard players set @s um2.dummy 23
execute if score @s um2.dummy matches 20 if score @s um2.diff matches 3.. run scoreboard players set @s um2.dummy 25
