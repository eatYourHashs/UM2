...
execute unless entity @s[tag=um2.quiet] run playsound um2:entity.empyrean_array.strike hostile @a ~ ~ ~ 0.8 1
execute if entity @s[tag=um2.quiet] run playsound um2:entity.empyrean_array.strike hostile @a ~ ~ ~ 0.3 1.2
