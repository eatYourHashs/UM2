...
execute if score @s um2.diff matches ..1 as @e[tag=um2.tracking] at @s facing entity @p[gamemode=!spectator,gamemode=!creative] eyes run tp ^ ^ ^0.015
execute if score @s um2.diff matches 2 as @e[tag=um2.tracking] at @s facing entity @p[gamemode=!spectator,gamemode=!creative] eyes run tp ^ ^ ^0.030
execute if score @s um2.diff matches 3.. as @e[tag=um2.tracking] at @s facing entity @p[gamemode=!spectator,gamemode=!creative] eyes run tp ^ ^ ^0.045
