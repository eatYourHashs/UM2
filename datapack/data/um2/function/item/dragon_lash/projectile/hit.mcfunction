...
execute if entity @s[tag=um2.charged] store result storage um2:storage temp.dmg double 0.15 run scoreboard players get @s um2.dummy2
...
function um2:item/dragon_lash/projectile/return