...
execute if score @s um2.dummy matches 1..9 if entity @s[tag=um2.left_clone] at @n[tag=um2.maxon] run tp @s ^1.5 ^ ^-1 ~-30 0
execute if score @s um2.dummy matches 1..9 if entity @s[tag=um2.right_clone] at @n[tag=um2.maxon] run tp @s ^-1.5 ^ ^-1 ~30 0
