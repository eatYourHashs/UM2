...
execute unless score @s um2.dummy matches 1.. if predicate um2:entity/walking_anim if entity @p[distance=..8,gamemode=!spectator] run function um2:entity/tyrion_demon/roar
