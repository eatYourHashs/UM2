...
execute if score @s um2.crossbow matches 1.. run function um2:entity/player/crossbow
...
execute if score @s um2.heap_driver matches 1.. unless entity @s[tag=um2.using_heap_driver] run function um2:item/heap_driver/stop_using
execute if score @s um2.heap_driver matches 1.. run tag @s remove um2.using_heap_driver
