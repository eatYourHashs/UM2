...
execute if entity @s[tag=um2.thunder_strike_main] run function um2:entity/empyrean_array/thunder_strike/main_tick
execute if entity @s[tag=um2.thunder_strike_support] run function um2:entity/empyrean_array/thunder_strike/support_tick

execute if entity @s[tag=um2.parallel_dash] run function um2:entity/empyrean_array/parallel_dash/tick
