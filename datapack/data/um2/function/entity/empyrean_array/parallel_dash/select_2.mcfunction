...
scoreboard players set @s um2.dummy -5
...
execute at @n[type=marker,tag=um2.empyrean_array_controller] facing entity @p[gamemode=!creative,gamemode=!spectator] feet rotated ~ 0 run tp @s ^6 ^1 ^-7.5 ~ 0
