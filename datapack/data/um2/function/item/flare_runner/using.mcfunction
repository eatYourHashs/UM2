...
execute if score @s um2.flare_runner matches 14 run playsound um2:item.flare_runner.charge player @a ~ ~ ~ 1 1.3
execute if score @s um2.flare_runner matches 26 run playsound um2:item.flare_runner.charge player @a ~ ~ ~ 1 1.6
