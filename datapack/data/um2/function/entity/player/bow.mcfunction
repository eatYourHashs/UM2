...
execute if data storage um2:storage temp.item.components."minecraft:custom_data".um_dat.demonic_reinforced_bow run function um2:item/demonic_reinforced_bow/shoot
