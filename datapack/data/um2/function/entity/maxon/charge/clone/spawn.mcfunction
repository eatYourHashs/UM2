...
execute if score @s um2.diff matches ..1 at @s run tp @n[tag=um2.new] ^1.5 ^ ^-1 ~-40 0
execute if score @s um2.diff matches 2 at @s run tp @n[tag=um2.new] ^1.5 ^ ^-1 ~-35 0
execute if score @s um2.diff matches 3.. at @s run tp @n[tag=um2.new] ^1.5 ^ ^-1 ~-30 0
