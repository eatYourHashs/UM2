# dummy3: amount of dmg taken to this body
# controller dummy3: overall hp left
...
execute unless entity @s[tag=um2.stagger] run scoreboard players operation @s um2.dummy3 += $temp.hp_change um2.dummy
execute if score @s um2.dummy3 matches 60.. run function um2:entity/empyrean_array/stagger
